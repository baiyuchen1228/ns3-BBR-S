...
try:
    ...
    data2 = np.loadtxt('1/10.1.1.1_49154_10.1.3.2_5000_rtt.txt')
    x1 = data1[:, 0]
    y1 = data1[:, 1]
    x2 = data2[:, 0]
    y2 = data2[:, 1]
    ...
    data2 = np.loadtxt('1/10.1.1.1_49154_10.1.3.2_5000_goodput.txt')
    x1 = data1[:, 0]
    y1 = data1[:, 1]
    x2 = data2[:, 0]
    y2 = data2[:, 1]
...
try:
    ...
    data2 = np.loadtxt('2/10.1.1.1_49154_10.1.3.2_5000_rtt.txt')
    x1 = data1[:, 0]
    y1 = data1[:, 1]
    x2 = data2[:, 0]
    y2 = data2[:, 1]
    ...
    data2 = np.loadtxt('2/10.1.1.1_49154_10.1.3.2_5000_goodput.txt')
    x1 = data1[:, 0]
    y1 = data1[:, 1]
    x2 = data2[:, 0]
    y2 = data2[:, 1]
...
try:
    ...
    data2 = np.loadtxt('3/10.1.1.1_49154_10.1.3.2_5000_rtt.txt')
    x1 = data1[:, 0]
    y1 = data1[:, 1]
    x2 = data2[:, 0]
    y2 = data2[:, 1]
    ...
    data2 = np.loadtxt('3/10.1.1.1_49154_10.1.3.2_5000_goodput.txt')
    x1 = data1[:, 0]
    y1 = data1[:, 1]
    x2 = data2[:, 0]
    y2 = data2[:, 1]
...
try:
    ...
    data2 = np.loadtxt('4/10.1.1.1_49154_10.1.3.2_5000_rtt.txt')
    x1 = data1[:, 0]
    y1 = data1[:, 1]
    x2 = data2[:, 0]
    y2 = data2[:, 1]
    ...
    data2 = np.loadtxt('4/10.1.1.1_49154_10.1.3.2_5000_goodput.txt')
    x1 = data1[:, 0]
    y1 = data1[:, 1]
    x2 = data2[:, 0]
    y2 = data2[:, 1]
